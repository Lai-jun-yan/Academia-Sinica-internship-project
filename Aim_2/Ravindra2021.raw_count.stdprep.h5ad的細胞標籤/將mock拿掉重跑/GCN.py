...
# adjacency matrix
A = sparse.load_npz(
    r"C:\Users\USER\Desktop\資訊所實習\計畫\資料探勘\Ravindra2021.raw_count.stdprep.h5ad的細胞標籤\將mock拿掉重跑\GCN_adjacency.npz"
)
...
#            0       0.98      0.99      0.99      1501
#            1       0.98      0.92      0.95       342

#     accuracy                           0.98      1843
#    macro avg       0.98      0.96      0.97      1843
...
# 未知的細胞最後被判定為感染的summary:
# Unknown → Infected: 18799 cells
# Viral transcript < 10: 17013 cells
# Percentage: 90.50%
# 病毒轉錄體的分布:
# 0: 2138
# 1~9: 14875
